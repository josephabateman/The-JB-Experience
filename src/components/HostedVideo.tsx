...
const HostedVideo: React.FC = () => {
  ...
  <a
    ...
    className="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-full transition"
  >
    <svg
  ...
  className="ml-auto flex items-center justify-center px-3 py-2 bg-gray-800 hover:bg-gray-900 text-white rounded-full transition max-w-max"
>
  {isMuted ? "Unmute 🔊" : "Mute 🔇"}
</button>
</div>
